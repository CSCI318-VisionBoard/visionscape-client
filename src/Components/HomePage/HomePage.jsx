...
const HomePage = () => {
    ...
    const carouselImages = [
        "/assets/trending_placeholder_1.avif",
        "/assets/trending_placeholder_2.avif",
        "/assets/trending_placeholder_3.avif",
    ];
        ...
        <div className="homepage">
            <div className="homepage-header">
                <div className="header-content">
                    ...
                    <button className="cta-button">Create Your Vision</button>
                </div>
            </div>
                ...
                <div className='vision-content'>
                    <div className='vision-feature'>
                        ...
                        <div className='feature-text'>
                            <h2>Pick Out Your Dreams</h2>
                            <p>Answer questions about your specific goals, whether academic, personal, or other, so we can design your vision board.</p>
                        </div>
                    </div>
                    ...
                    <div className='vision-feature'>
                        ...
                        <div className='feature-text'>
                            ...
                            <p>Now that you've obtained your vision, let's find out how to get there.</p>
                        </div>
                    </div>
                </div>
            </div>
